package com.salahmj.spitch2txt;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==1)
        {
            ...
            {
                Toast.makeText(this,"Yayy!!! Permission Granted",Toast.LENGTH_SHORT);
            }
            else
            {
                Toast.makeText(this,"OOPS!!! Permission Denied",Toast.LENGTH_SHORT);
            }
        }
    }
}